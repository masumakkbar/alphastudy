<?php
  if (is_home() && !is_front_page() || is_home() && is_front_page()){
		...
		$skew_style        = (!empty($tp_theme_option['skew_off'])) ? 'themephi-skew-head' : '';
...
$main_menu_center = (!empty($tp_theme_option['main_menu_center'])) || ($menu_center_page == 'yes')  ? 'main-menu-center' : '';

$main_menu_icon = (!empty($tp_theme_option['main_menu_icon'])) ? 'main-menu-icon-hide' : '';
