...
class Themephi_Elementor_Blog_Category_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TP Blog Category', 'tp-elements' );
	}
	...
	protected function register_controls() {		
		...
		$this->add_control(
			'blog_grid_style',
			[
				'label'   => esc_html__( 'Blog Category Style', 'tp-elements' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'style1',
				'options' => [					
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .blog-category-item',
            ]
        );
        ...
        $this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item:hover' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
					'{{WRAPPER}} .blog-category-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .themephi-blog-grid1.blog-category-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],              
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .themephi-blog-grid .blog-category-item' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Background', 'tp-elements' ),
                'types' => [ 'classic', 'gradient', 'tp-elements' ],
                'selector' => '{{WRAPPER}} .blog-category-image',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-category-image' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
					'{{WRAPPER}} .blog-category-image, {{WRAPPER}} .blog-category-image img, {{WRAPPER}} .blog-category-image::before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],              
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
				...
				'separator' => 'before',
				'selectors' => [
					'{{WRAPPER}} .blog-category-image' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
        $this->add_responsive_control(
			...
			[
				...
				'separator' => 'before',
				'selectors' => [
					'{{WRAPPER}} .blog-category-image' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
            'blog_image_overlay_color',
            [
                'label' => esc_html__( 'Overlay Color', 'tp-elements' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-image::before' => 'background-color: {{VALUE}};',
                ],      
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content .title a' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content .title a:hover' => 'color: {{VALUE}};',
                ],                
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content .title:hover a' => 'background-image: -webkit-gradient(linear, left top, right top, color-stop(50%, {{VALUE}}), color-stop(50%, transparent)); background-image: linear-gradient(to right, {{VALUE}} 50%, transparent 50%);',
                ],                
            ]
        );
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => 
                    '{{WRAPPER}} .blog-category-item .blog-category-content .title',
			]
		);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content .title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
		    ...
		    [
		        'name' => 'title_border',
		        'selector' => '{{WRAPPER}} .blog-category-item .blog-category-content .title'               
		    ]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content p.txt ' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .themephi-blog-grid1 .blog-category-content p.txt ' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => 
                    '{{WRAPPER}} .blog-category-item .blog-category-content p.txt ',
                    '{{WRAPPER}} .themephi-blog-grid1 .blog-category-content p.txt ',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content p.txt ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .themephi-blog-grid1 .blog-category-content p.txt ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-content, {{WRAPPER}} .blog-category-content .txt' => 'text-align: {{VALUE}}',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'condition' => [
                    'blog_grid_style' => ['style11'],
                ],
                'selectors' => [
                    '{{WRAPPER}} .blog-category-content' => 'align-items: {{VALUE}}',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content' => 'background:{{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );  
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        ); 
        ...
        $this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        'name' => 'btn_typography',
		        'selector' => '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .blog-category-item .blog-category-content .btn-btm' => 'border-color: {{VALUE}};',
                    '{{WRAPPER}} .themephi-blog-grid1 .blog-category-content .btn-btm' => 'border-color: {{VALUE}};',
                ],  
                'condition' => [
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '',
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a i' => '-webkit-transform: translateX(calc(-1 * {{SIZE}}{{UNIT}})); transform: translateX(calc(-1 * {{SIZE}}{{UNIT}}));',
		            '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
                    '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content:hover .btn-part a,
                    {{WRAPPER}} .blog-category-item .btn-part a:hover, 
                    {{WRAPPER}} .blog-category-item .blog-category-content:focus .btn-part' => 'color: {{VALUE}}',
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item .blog-category-content:hover .btn-part a' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .blog-category-item:hover .blog-category-content .btn-part a i' => '-webkit-transform: translateX(calc(-1 * {{SIZE}}{{UNIT}})); transform: translateX(calc(-1 * {{SIZE}}{{UNIT}}));',
		            '{{WRAPPER}} .blog-category-item:hover .blog-category-content .btn-part a i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
                    '{{WRAPPER}} .blog-category-item:hover .blog-category-content .btn-part a i' => '-webkit-transform: translateX(calc(-1 * {{SIZE}}{{UNIT}})); transform: translateX(calc(-1 * {{SIZE}}{{UNIT}}));',
                    '{{WRAPPER}} .blog-category-item:hover .blog-category-content .btn-part a i' => '-webkit-transform: translateX({{SIZE}}{{UNIT}}); transform: translateX({{SIZE}}{{UNIT}});',
		        ],
		    ]
        ...
        $this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}} .blog-category-item .blog-category-content .btn-part a:hover'               
		    ]
		);
	...
	protected function render() {
		...
		if( $settings['blog_grid_source'] == 'slider' ) {
			...
			$pagination_class = '.tp-blog-category-pagination ';
		...
		<div class="themephi-blog-grid tp-blog-category--<?php echo esc_attr( $settings['blog_grid_style'] ); ?> <?php echo esc_attr( $settings['image_hover_effect'] ); ?>">
            <?php if( $settings['blog_grid_source'] == 'dynamic' ) : ?>           
            <div class="tp-blog-category-dynamic-wrapper">
                <div class="row blog-gird-item <?php if ( $settings['enable_item_gutter'] == 'yes' ) : ?>  g-0 <?php endif; ?> " <?php if( $settings['messonry_show_hide'] == 'yes' ) : ?> data-masonry=' { "columnWidth": ".grid-item", "percentPosition": false }' <?php endif; ?> >
                <?php elseif($settings['blog_grid_source'] == 'slider') : ?>   
            <div class="swiper tp_blog-category-<?php echo esc_attr($unique); ?> ">
                ...
                <?php endif; ?>
                    ...
                    $total_categories = wp_count_terms('category', ['taxonomy' => 'category', 'hide_empty' => false]);
                    ...
                    if( $settings['blog_pagination_show_hide'] == 'yes' ) {
                        ...
                        if ($total_pages > 1) {
                            echo '<div class="tp-blog-category-pagination">';
                            echo paginate_links([
                                'total' => $total_pages,
                                'current' => $paged,
                                'format' => '?paged=%#%',
        ...
        <script>
            jQuery(document).ready(function(){
                ...
                var swiper = new Swiper(".tp_blog-category-<?php echo esc_attr($unique); ?> ", {				
                    ...
                    navigation: {
                        nextEl: ".tp-blog-category-slide-next",
                        prevEl: ".tp-blog-category-slide-prev",
                    },
                    breakpoints: {
