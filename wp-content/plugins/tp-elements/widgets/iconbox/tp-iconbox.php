...
class Themephi_Icon_Box_Widget extends \Elementor\Widget_Base {
	 ...
	 */
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .tp-box-inner-wrapper' => 'align-items: {{VALUE}}'
                ],
            ]
        );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .tp-iconbox-area .services-btn.icon-before i' => 'margin-right: {{SIZE}}{{UNIT}};',
		            '{{WRAPPER}} .tp-iconbox-area .services-btn.icon-after i' => 'margin-left: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->start_controls_tabs( '_tabs_item_box' );

		$this->start_controls_tab(
		    '_tab_item_box_normal',
		    [
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .box-inner:hover' => 'border-color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '{{WRAPPER}} .icon-area .icon svg' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
		            '{{WRAPPER}} .icon-area > img' => 'width: {{SIZE}}{{UNIT}} !important;',
		        ],
		        'condition' => [
		            'icon_type' => 'icon'
		        ]
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .icon-area .icon' => 'line-height: {{SIZE}}{{UNIT}} !important;',
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .icon-area .icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .icon-area .icon, {{WRAPPER}} .icon-area .after-img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        'name' => 'media_border',
		        'selector' => '{{WRAPPER}} .icon-area .icon',
		    ]
		);
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .box-inner:hover .icon-area .icon' => 'border-color: {{VALUE}} !important',
		        ]
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '{{WRAPPER}} .icon-area .icon svg path' => 'fill: {{VALUE}} !important',
		        ],
		        'condition' => [
		            'icon_type' => 'icon'
		        ]
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '{{WRAPPER}} .box-inner:hover .icon-area .icon svg path' => 'fill: {{VALUE}} !important',
		        ],
		        'condition' => [
		            'icon_type' => 'icon'
		        ]
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'label' => esc_html__( 'Before Image', 'tp-elements' ),
		        'separator' => 'before'
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .iconbox-after-arrow-image .after-img' => 'top: {{SIZE}}{{UNIT}} !important;',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .iconbox-after-arrow-image .after-img' => 'left: {{SIZE}}{{UNIT}} !important;',
		        ],
		    ]
		);
		...
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .iconbox-after-arrow-image .after-img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
		...
		$this->add_control(
            'image_opacity_hover',
            [
                'label' => esc_html__( 'Hover Opacity', 'tp-elements' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 1,
                ...
                'selectors' => [
                    '{{WRAPPER}} .box-inner:hover .after-img' => 'opacity: {{SIZE}};',
                ],
            ]
        );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .text-area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .tp-iconbox-area .box-inner .text-area .iconbox-title .title:hover, {{WRAPPER}}  .tp-iconbox-area .box-inner .text-area .iconbox-title .title:hover a' => 'color: {{VALUE}}',
		            '{{WRAPPER}} .tp-iconbox-area.tp-iconbox-style2 .box-inner:hover .text-area .iconbox-title .title, {{WRAPPER}}  .tp-iconbox-area.tp-iconbox-style2 .box-inner:hover .text-area .iconbox-title .title a' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'label' => esc_html__( 'Typography', 'tp-elements' ),
		        'selector' => '{{WRAPPER}}  .tp-iconbox-area .box-inner .tp-badge',
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => 'color: {{VALUE}};',                   
                ],
            ]
        );
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => 'background-color: {{VALUE}};',                      
                ],
            ]
        );
        ...
        $this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => 'top: {{SIZE}}{{UNIT}};',                   
                ],
            ]
        );
		...
		$this->add_responsive_control(
            ...
            [
               ...
               'size_units' => [ 'px', '%' ],
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => 'left: {{SIZE}}{{UNIT}};',                   
                ],
            ]
        );
        ...
        $this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            ...
		            '(desktop){{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => '-ms-transform: translate({{media_offset_x.SIZE || 0}}px, {{media_offset_y.SIZE || 0}}px) rotate({{SIZE}}deg); 
		            ...
		            '(tablet){{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => '-ms-transform: translate({{media_offset_x_tablet.SIZE || 0}}px, {{media_offset_y_tablet.SIZE || 0}}px) rotate({{SIZE}}deg); -webkit-transform: translate({{media_offset_x_tablet.SIZE || 0}}px, {{media_offset_y_tablet.SIZE || 0}}px) rotate({{SIZE}}deg); transform: translate({{media_offset_x_tablet.SIZE || 0}}px, {{media_offset_y_tablet.SIZE || 0}}px) rotate({{SIZE}}deg) !important;',
		            '(mobile){{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => '-ms-transform: translate({{media_offset_x_mobile.SIZE || 0}}px, {{media_offset_y_mobile.SIZE || 0}}px) rotate({{SIZE}}deg); -webkit-transform: translate({{media_offset_x_mobile.SIZE || 0}}px, {{media_offset_y_mobile.SIZE || 0}}px) rotate({{SIZE}}deg); transform: translate({{media_offset_x_mobile.SIZE || 0}}px, {{media_offset_y_mobile.SIZE || 0}}px) rotate({{SIZE}}deg) !important;',
		        ],
		    ]
		);
        ...
        $this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .tp-iconbox-area .box-inner .tp-badge' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
		        ],
		    ]
		);
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		            '{{WRAPPER}} .tp-iconbox-area .box-inner .services-btn-part' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .tp-iconbox-area .box-inner .services-btn-part .services-btn:hover, {{WRAPPER}} .tp-iconbox-area .box-inner .services-btn-part:focus .services-btn' => 'color: {{VALUE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}} .tp-iconbox-area .box-inner:hover .services-btn-part .services-btn, {{WRAPPER}} .tp-iconbox-area .box-inner:focus .services-btn-part .services-btn' => 'background-color: {{VALUE}};',
		        ],
		    ]
		);
	...
	protected function render() {
		$settings = $this->get_settings_for_display();
            ...
            $this->add_render_attribute( 'badge_title', 'class', 'tp-badge' );	
		?>

		<?php 
        if($settings['service_grid_style'] == 'style2'){ ?>
			<div class="tp-iconbox-area iconbox-after-arrow-image tp-iconbox-<?php echo esc_attr( $settings['service_grid_style'] ); ?>">
				<div class="box-inner">
					...
					<div class="tp-badge"><?php echo wp_kses_post($settings['badge_title']);?></div>
					<?php } ?>

				</div>
			</div>
		<?php } else {?>
		<div class="tp-iconbox-area iconbox-after-arrow-image">
		    <div class="box-inner">
