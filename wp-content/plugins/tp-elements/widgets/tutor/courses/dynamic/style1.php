        ...
        <div class="tp-course-content">  
            <div class="tp-course-content-top">
                ...
                <div class="tp-course-author">
                    <a href="<?php echo $profile_url; ?>"><?php echo tutor_utils()->get_tutor_avatar( $post->post_author ); ?></a> - By <a class="name" href="<?php echo $profile_url; ?>"> <?php esc_html_e( get_the_author() ); ?></a>
                </div>
                <?php } ?>
            </div> 
