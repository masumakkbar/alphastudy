<div class="tp-course-search-area">
    <form action="<?php echo esc_url(home_url('/')); ?>" method="get" id="course-search-form">
        <div class="tp-coupn-search">
            <select class="tp-course-category" id="course-category-select">
            ...
            <div class="tp-coupn-search-input-wrapper">
                <input type="text" name="s" placeholder="Search courses here..." class="tp-coupn-search-input" id="course-search-input" value="<?php echo get_search_query(); ?>">
