<div  class="single--item">
    ...
    <?php }?>
        ...
        <div class="rating-heading">
            <?php if(!empty($customheadingimage)):?>
                <img class="rating-heading-img" src="<?php echo esc_url($customheadingimage); ?>" alt="image">
            <?php endif;?>
            <?php if(!empty($custom_heading_text)):?>
                <span class="rating-heading-text"><?php echo wp_kses_post($custom_heading_text); ?></span>
            <?php endif;?>
        </div>
