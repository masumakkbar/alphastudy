...
class Themephi_Elementor_pro_Gallery_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
                     '{{WRAPPER}}  .tp-gallerys .galley-img .p-zoom i:before, .tp-gallerys .galley-img .zoom-icon i:before' => 'font-size: {{SIZE}}{{UNIT}}'
                ],
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tp-gallerys .galley-img .zoom-icon' => 'color: {{VALUE}};',
                ],                
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp-gallerys .galley-img .zoom-icon:hover' => 'color: {{VALUE}};',
                ],                
            ]
        );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'type' => Controls_Manager::COLOR,
		        'selectors' => [
		            '{{WRAPPER}}  .tp-gallerys .galley-img .gallery-titles' => 'color: {{VALUE}}',
		        ],
		        'condition' => [
		...
		$this->add_group_control(
		    ...
		    [
		        ...
		        'selector' => '{{WRAPPER}}  .tp-gallerys .galley-img .gallery-titles',
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .tp-gallerys .galley-img .gallery-titles' => 'left: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'gallery_cation_style' => 'show'
		        ],
		...
		$this->add_responsive_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .tp-gallerys .galley-img .gallery-titles' => 'top: {{SIZE}}{{UNIT}};',
		        ],
		        'condition' => [
		            'gallery_cation_style' => 'show'
		        ],
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .tp-gallerys .file-list-image:before, .tp-gallerys .galley-img:before' => 'background: {{VALUE}};',
                ],                
            ]
        );
	...
	protected function render() {
		...
		?>	
	    <div class="row tp-gallerys elementor-image-gallery <?php echo esc_html( $settings['gallery_column_gap'] );?>"> 	   			
	   		<?php
				foreach ( $settings['tp-gallery'] as $image ) { 
