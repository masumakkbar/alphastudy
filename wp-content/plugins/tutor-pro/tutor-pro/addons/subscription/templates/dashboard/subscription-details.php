			...
			<div>
				...
				<div class="tutor-mt-12">
					<label class="tutor-d-flex tutor-gap-1 tutor-align-start" for="auto_renew">
						...
						>
						<div>
							<div class="tutor-fs-7 tutor-fw-normal"><?php esc_html_e( 'Enable Auto-Renewal', 'tutor-pro' ); ?></div>
				...
				<div class="tutor-d-flex tutor-gap-3 tutor-fs-7 tutor-mt-20" style="font-size: 13px;">
					<div>
