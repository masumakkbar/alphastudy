...
function custom_sidebar_callback($post) {
  ...
  $output1 = '<div class="radio-select"><p><label for="myplugin_layout">' . esc_html__("Choose Layout", 'tp-framework') . '</label></p>';
  ...
  // Sidebar options
  $output = '<p><label for="myplugin_new_field">' . esc_html__("Choose a sidebar layout", 'tp-framework') . '</label></p>';
