...
function tptheme_contact_widget() {
    register_widget( 'contact_widget' );
}
add_action( 'widgets_init', 'tptheme_contact_widget' );
...
class contact_widget extends WP_Widget {
   ...
   function __construct() {
    parent::__construct(
      'contact_widget', 
      __('TP Contact Info', 'tp-framework'),
      array( 'description' => __( 'Display your contact info!', 'tp-framework' ), )
    );
  }
  ...
  <ul class="footer-contact-ul">
    <?php           
      ...
      if (!empty($hour)){
            echo '<li><i class="fa fa-clock-o"></i>'.esc_html('Office Hour: ', 'tp-framework').'<span class="time">'.nl2br($hour) .'</span></li>';    
      }
      if (!empty($address2)){
            echo '<li class="address1"><i class="fa fa-map-marker"></i><span>'. nl2br($address2) .'</span></li>'; 
        }
    ?>
  ...
  function update($new_instance, $old_instance) {   
    ...
    function form($instance) {  
     ...
     ?>      
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('intro')); ?>"><?php esc_html_e('Intro:', 'tp-framework'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('address2')); ?>"><?php esc_html_e('Address:', 'tp-framework'); ?></label>
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php esc_html_e('Phone:', 'tp-framework'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email:', 'tp-framework'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('app')); ?>"><?php esc_html_e('Website:', 'tp-framework'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('fax')); ?>"><?php esc_html_e('Fax:', 'tp-framework'); ?></label> 
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('hour')); ?>"><?php esc_html_e('Opening Hour:', 'tp-framework'); ?></label> 
